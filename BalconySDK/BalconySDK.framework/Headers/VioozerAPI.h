...
/**
 * presents or update my activity view controller
 */
-(void)openMyActivity;
-(void)updateMyActivity;
/**
...
-(void) showSendReportScreen:(BOOL) withCamera;
...
//BalconySDK: opens Live Streaming VC
-(void) showLiveStreamingVCForQuestionID: (NSString*) questionId;
 ...
 */
- (void) checkPermitAndSaveIfChanged;
...
- (void) presentVCfromHomeScreen: (UIViewController*) vc;

/*
 * MiniSDK: centralized management of camera preview
 */
- (void) setupCameraPreviewParametersWithCompletion: (void(^)(BOOL result))completion;
- (BOOL) showCameraPreviewOn: (UIView*) cameraView; // returns bool for success or fail
- (void) removeCameraPreview;
- (void) showAlertCameraSettingsOn: (UIViewController*) vc;
- (void)getCameraAuthWithCompletion:(void(^)(BOOL granted))completion;
