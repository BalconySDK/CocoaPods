Pod::Spec.new do |s|
  ...
  s.public_header_files = "VioozerSDK-lib/*.{h, swift}"
  s.resources = "VioozerSDK-lib/VioozerResources.bundle"
  s.preserve_paths = 'VioozerSDK-lib/libVioozerSDK.a', 'VioozerSDK-lib/*.{h,swift,nib,ttf}'
  ...
  s.pod_target_xcconfig = { "OTHER_LDFLAGS" => "-lz, -ObjC", "DEFINES_MODULE" => "YES", 'SWIFT_OBJC_BRIDGING_HEADER' => '$(PODS_TARGET_SRCROOT)/../../VioozerSDK/VioozerAPI.h' }
